...
class CollectionTest extends TestCase
{
    ...
    public function testMapSpread()
    {
        ...
        $this->assertEquals([
            new Person("Roni Purwanto"),
            new Person("Ahmad Roni"),
        ], $result->all());
    }
    ...
    public function testCombine()
    {
        ...
        $collection2 = collect(["Roni", "Indonesia"]);
    ...
    {
        $collection = collect(["Ahmad", "Roni", "Purwanto"]);

        $this->assertEquals("Ahmad-Roni-Purwanto", $collection->join("-"));
        $this->assertEquals("Ahmad-Roni_Purwanto", $collection->join("-", "_"));
        $this->assertEquals("Ahmad, Roni and Purwanto", $collection->join(", ", " and "));
    ...
    {
        $collection = collect(["Ahmad", "Roni", "Purwanto"]);
        $this->assertTrue($collection->contains("Roni"));
        $this->assertTrue($collection->contains(function ($value, $key) {
            return $value == "Purwanto";
        }));
    }
